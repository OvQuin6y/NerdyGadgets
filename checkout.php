...
<?php if (isset($_SESSION["klantID"])) { ?>
    ...
    <form class="Checkout_form" style="padding-left: 0" method="post" action="ideal.php">
        <input type="submit" value="Confirm and continue" style="font-size: 17px; width: 20vh" name="goToIdeal2"
               class="Buttons_checkout"><br><br>
    </form>
<?php } else { ?>
    <form class="Checkout_form" method="post" action="ideal.php">
        ...
        <input type="text" id="dpcode" name="dpcode" placeholder="Delivery postal code" class=Inputfields
               required><br><br>
        ...
        <input type="email" id="e-mail" name="e-mail" placeholder="e.g Example@windesheim.nl" class=Inputfields
               required><br><br>
        <input type="number" id="pnumber" name="pnumber" placeholder="Phone number" class=Inputfields required><br><br>
        <input type="text" id="daline1" name="daline1" required placeholder="Delivery Address"
               class=Inputfields><br><br>
        <input type="text" id="daline2" name="daline2" placeholder="Apartment, suite, etc. (Optional)"
               class=Inputfields><br><br>
        <input type="text" id="paline1" name="paline1" placeholder="Postal address" class=Inputfields required><br><br>
        <input type="text" id="paline2" name="paline2" placeholder="(Optional) Postal address 2"
               class=Inputfields><br><br>
        <input type="submit" value="Back to shopping cart" style="font-size: 17px;" href="cart.php"
               class="Buttons_checkout" formnovalidate><br>
