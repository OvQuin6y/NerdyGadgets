...
<div class="bodyContainer">
    <div id="formPopup" class="formPopup">
        <form method="post" action="profile.php">
            <div class="topContainer">
                <h3 id="title"><?php echo getTranslation($databaseConnection, $lang, "Edit_details_profile")?></h3>
                ...
                <form method="post" action="profile.php">
                    <div class="editForm">
                        <div class="flexContainer">
                            <label id="labelEdit"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_voornaam")?>:</label>
                            <input id="inputEdit" type="text" name="firstName" value="<?= $user["FirstName"] ?>">
                            <label id="labelEdit2"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_achternaam")?>:</label>
                            ...
                            <label id="labelEdit4"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_telefoonnummer")?>:</label>
                            <input id="inputEdit4" type="text" name="phoneNumber" value="<?= $user["PhoneNumber"] ?>">
                            <label id="labelEdit5"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_postcode")?>:</label>
                            <input id="inputEdit5" type="text" name="postalCode" value="<?= $user["PostalCode"] ?>">
                            <label id="labelEdit6"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_huisnummer")?>:</label>
                            <input id="inputEdit6" type="text" name="houseNumber" value="<?= $user["HouseNumber"] ?>">
                            <label id="labelEdit7"><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_stad")?>:</label>
            ...
            <div class="bottomContainer">
                <input type="submit" name="submit" class="submitForm" value="<?php echo getTranslation($databaseConnection, $lang, "Submit_profile")?>" id="submitForm">
            </div>
        </form>
    </div>
    <div class="mainContainer">
        <div class="userDetailsContainer">
            <div class="left">
                <h5><?php echo getTranslation($databaseConnection, $lang, "Welkom_profile")?></h5>
                <h4><?= $user["FirstName"]; ?> <?= $user["LastName"] ?></h4>
            </div>
            <div class="middle">
                <h5>Email: <?= $user["Email"] ?></h5>
                <h5><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_telefoonnummer")?>: <?= $user["PhoneNumber"] ?></h5>
                <h5><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_postcode")?> & <?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_huisnummer")?>: <?= $user["PostalCode"] ?>, <?= $user["HouseNumber"] ?></h5>
                <h5><?php echo getTranslation($databaseConnection, $lang, "Persoonsgegevens_stad")?>: <?= $user["City"] ?></h5>
            </div>
            <div class="right">
                <h5 onclick="openPopup()"><?php echo getTranslation($databaseConnection, $lang, "Edit_profile_button")?></h5>
            </div>
        </div>
        <div class="optionsContainer">
            ...
            <div class="account">
                ...
                <h6><?php echo getTranslation($databaseConnection, $lang, "Mijn_orders")?></h6>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    <path fill-rule="evenodd"
                          d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z"
                          clip-rule="evenodd"/>
                </svg>
                <h6><?php echo getTranslation($databaseConnection, $lang, "Favorieten_profile")?></h6>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <h6><?php echo getTranslation($databaseConnection, $lang, "Notificaties_profile")?></h6>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    <path d="M12 1.5a.75.75 0 01.75.75V7.5h-1.5V2.25A.75.75 0 0112 1.5zM11.25 7.5v5.69l-1.72-1.72a.75.75 0 00-1.06 1.06l3 3a.75.75 0 001.06 0l3-3a.75.75 0 10-1.06-1.06l-1.72 1.72V7.5h3.75a3 3 0 013 3v9a3 3 0 01-3 3h-9a3 3 0 01-3-3v-9a3 3 0 013-3h3.75z"/>
                </svg>
                <h6><?php echo getTranslation($databaseConnection, $lang, "Placeholder_profile")?></h6>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    <path d="M12 1.5a.75.75 0 01.75.75V7.5h-1.5V2.25A.75.75 0 0112 1.5zM11.25 7.5v5.69l-1.72-1.72a.75.75 0 00-1.06 1.06l3 3a.75.75 0 001.06 0l3-3a.75.75 0 10-1.06-1.06l-1.72 1.72V7.5h3.75a3 3 0 013 3v9a3 3 0 01-3 3h-9a3 3 0 01-3-3v-9a3 3 0 013-3h3.75z"/>
                </svg>
                <h6><?php echo getTranslation($databaseConnection, $lang, "Placeholder_profile")?></h6>
                ...
                <h6><?php echo getTranslation($databaseConnection, $lang, "Settings_profile")?></h6>
            </div>
        </div>
